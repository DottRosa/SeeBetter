 ...
 *
 * Filtro di simulazione della vista normale
 */

public class NormalFilter extends CameraFilter{
    ...
    public NormalFilter(Context context) {
        ...
        //Imposto il filtro della vista normale
        program = MyGLUtils.buildProgram(context, Filters.VERTEX, Filters.NORMAL_SHADER);
    }
