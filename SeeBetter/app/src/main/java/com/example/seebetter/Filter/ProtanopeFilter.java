 ...
 *
 * Filtro di simulazione protanope
 */

public class ProtanopeFilter extends CameraFilter{
     ...
     */
    public ProtanopeFilter(Context context) {
        super(context);

        //Imposto il filtro protanope
        program = MyGLUtils.buildProgram(context, Filters.VERTEX, Filters.PROTANOPE_SIMULATION_SHADER);
    }
