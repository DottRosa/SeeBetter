 ...
 *
 * Filtro di simulazione tritanope
 */

public class TritanopeFilter extends CameraFilter{
     ...
     */
    public TritanopeFilter(Context context) {
        super(context);

        //Imposto il filtro tritanope
        program = MyGLUtils.buildProgram(context, Filters.VERTEX, Filters.TRITANOPE_SIMULATION_SHADER);
    }
