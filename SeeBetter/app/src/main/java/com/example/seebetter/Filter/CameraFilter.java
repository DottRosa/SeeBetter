...
import com.example.seebetter.RenderBuffer;

/**
 * @author DottRosa (marco1rosa@gmail.com)
 *
 * Classe astratta responsabile dell'applicazione dei filtri
 */
public abstract class CameraFilter {
    static final float SQUARE_COORDS[] = {  //Per evitare lo strech dell'immagine
            1.1f, -1.0f,
            -1.1f, -1.0f,
            1.1f, 1.0f,
            -1.1f, 1.0f,
